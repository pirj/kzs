Kzs::Application.routes.draw do
  ...
  # SAKEFF routing
  get '/dashboard' => redirect('/dashboard'), as: :users_root
  get '/controls' => redirect('/controls'), as: :control_dashboard
  get '/units' => redirect('/units'), as: :units
  get '/messages/broadcast' => redirect('/messages/broadcast'), as: :messages_broadcast
  get '/dialogues' => redirect('/dialogues'), as: :dialogues
  get '/permits' => redirect('/permits'), as: :scope_permits
  get '/tasks' => 'tasks/tasks#index', as: :tasks_module
  get '/users/sign_out' => redirect('/users/sign_out'), as: :destroy_user_session
  get '/documents' => redirect('/documents'), as: :documents
