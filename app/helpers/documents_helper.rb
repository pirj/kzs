...
module DocumentsHelper
  def pdf_to_png(document, width, height)
    ...
    unless File.file?("/system/documents/document_#{document.id}.pdf") 
    ...
    image_tag "#{path}document_#{document.id}.png", class: 'table-img-md'
  end
...
<span class="attach-title link">Распоряжение №321</span>
