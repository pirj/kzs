...
(function (document, window, React) {
    var CLASS_NAME_ATTR = 'data-react-popup-class';
    var PROPS_ATTR = 'data-react-popup-props';
    ...
    var mountReactComponents = function () {
        ...
        for (var i = 0; i < nodes.length; ++i) {
            ...
            React.renderComponent(constructor(props), document.getElementsByClassName('js-popup-layout')[0]);
        }
    };
