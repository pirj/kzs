class Ability
  ...
  def initialize(user)  
    ...
    can :apply_sent,     Documents::OfficialMail, document:{sender_organization_id: user.organization_id}
    ...
    can :apply_sent,     Documents::Order, document:{sender_organization_id: user.organization_id}
    ...
    can :apply_sent,     Documents::Report, document:{sender_organization_id: user.organization_id}
